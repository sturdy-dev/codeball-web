<script lang="ts">
	...
	$: standaloneCodeballComment = comments.length === 1 && comments[0].isCodeball;
	$: render = (standaloneCodeballComment && show) || !standaloneCodeballComment;
</script>
				...
				<div class="flex flex-row space-x-4">
					...
					<div class="space-y-2 overflow-hidden">
						<div class="flex items-center space-x-2">
							...
							<div class="text-gray-600">{comment.isCodeball ? 'now' : '10 seconds ago'}</div>
						</div>
						<div class="font-sans">
