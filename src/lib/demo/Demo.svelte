...
<div class="flex flex-col-reverse justify-around lg:flex-row lg:space-x-4">
	<div class="space-y-4 lg:w-80">
		<div class="font-mono">Want to see something cool?</div>
	...
	<div class="duration-400 mt-16 flex-1 transition-all ease-in lg:mt-0">
		<div class="transition-all duration-1000 ease-in-out" class:opacity-0={!selectedFile}>
			<div class="text-4xl">
