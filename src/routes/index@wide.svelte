...
<div class="flex w-full flex-col items-center bg-rose-100 pt-16 overflow-hidden">
    <div class="flex px-8 w-full justify-around">
        <div class="w-full max-w-7xl space-y-8">
            <h1 class="text-5xl font-bold">Codeball is your AI powered coding toolset</h1>
            <p class="max-w-3xl text-gray-600">
                ...
                some of the most powerful coding AIs in the world.
            </p>
            <p class="max-w-3xl text-gray-600">
    ...
    <img class="md:-mt-[6rem] lg:-mr-[44rem] xl:-mr-[32rem] lg:-mt-[16rem]" src="/armadillo/big-office.png"/>
</div>
...
<div class="bg-black pb-32 text-white">
    <div class="mx-auto max-w-7xl space-y-8 p-14 text-center">
        <h2 class="text-5xl font-bold">Let's go</h2>
        <Button href="https://github.com/sturdy-dev/codeball-action">Show me how</Button>
    </div>
</div>
