...
<article class="font-mono">
	...
	<div class="my-8 flex flex-col gap-16 lg:flex-row">
		<div class="flex flex-col gap-8">
			<div class="text-md text-gray-700 lg:grid lg:grid-cols-3">
				...
				<div class="bg-gray-300 p-2 py-5 lg:bg-transparent lg:p-4">
				...
				<div class="p-2 lg:bg-gray-200 lg:p-4">
					...
					<p>
						...
						<br />
						<span class="text-gray-400">Example: Code linters and formatters.</span>
					</p>
				</div>
				...
				<div class="p-2 lg:p-4">
					<strong class="lg:hidden">💻</strong>
					<p>
						Tools aware of the immediate code context.<br />
						<span class="text-gray-400"
							>Example: Auto-complete, Refactoring suggestions, static code analysis.</span
						>
					</p>
				</div>
				...
				<div class="p-2 lg:bg-gray-200 lg:p-4">
					...
					<p>
						...
						gets confused.
						<br />
						<span class="text-gray-400">Example: Tesla</span>
					</p>
				</div>
				<div class="p-2 lg:bg-gray-200 lg:p-4">
					<strong class="lg:hidden">💻</strong>
				...
				<div class="p-2 lg:p-4">
					...
					<p>
						...
						<span class="text-gray-400">Example: Waymo</span>
					</p>
				</div>
				<div class="p-2 lg:p-4">
					<strong class="lg:hidden">💻</strong>
