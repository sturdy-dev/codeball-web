	...
	<div class="my-8 flex flex-col gap-16 lg:flex-row">
		<div class="flex flex-col gap-8">
			...
			>
				...
				<p>Codeball collects your data so that we can:</p>
				<ul>
					<li>Process your order and manage your account.</li>
					<li>Provide the Codeball services.</li>
				</ul>

				<h2>Appendix: Sub processors</h2>

				<p>
					The following sub-processors are used to provide parts of the Codeball service. This list
					can change as the business needs for Codeball changes. It is not a part of the Privacy
					Policy.
				</p>
				...
				<p>
					...
					any of these rights, please contact us via email:
					<a href="mailto:support@getsturdy.com">support@getsturdy.com</a>.
				</p>
				...
				<p>
					The Our Company website contains links to other websites. Our privacy policy applies only
				...
				<p>Email us at: <a href="mailto:support@getsturdy.com">support@getsturdy.com</a></p>

				<h2>If you are displeased with us</h2>
				<p>
					If you are dissatisfied with how we process your personal data, please contact our data
